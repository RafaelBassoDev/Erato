        ...
        WindowGroup {
            ...
            .onAppear {
                ...
                for _ in 1...5 {
                    ...
                    let novel = Novel(title: "Sword God in a Magical World", author: "Er Gen", description: "Some DescriptionSome DescriptionSome DescriptionSome DescriptionSome DescriptionSome DescriptionSome DescriptionSome DescriptionSome DescriptionSome DescriptionSome Description", chapters: [chapter, chapter, chapter, chapter])
                    tmpNovels.append(novel)
                    novels = tmpNovels;
                }
            }
        }
